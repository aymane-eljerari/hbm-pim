...
np.random.seed(1113)
data_in1 = np.random.randint(0, 2**62, size=(DNUM, ELEM_LEN, COEFFS), dtype=np.uint64)
data_in2 = np.random.randint(0, 2**62, size=(DNUM, ELEM_LEN, COEFFS), dtype=np.uint64)
data_in3 = np.random.randint(0, 2**62, size=LIMBS, dtype=np.uint64)
data_out = np.zeros((ELEM_LEN, COEFFS), dtype=np.uint64)
