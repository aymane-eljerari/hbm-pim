...
union BurstType {
  ...
  BurstType(float x0, float x1, float x2, float x3, float x4, float x5,
            float x6, float x7) {
    set(x0, x1, x2, x3, x4, x5, x6, x7);
  }

  BurstType(fp16 x0, fp16 x1, fp16 x2, fp16 x3, fp16 x4, fp16 x5, fp16 x6,
            fp16 x7, fp16 x8, fp16 x9, fp16 x10, fp16 x11, fp16 x12, fp16 x13,
            fp16 x14, fp16 x15) {
    set(x0, x1, x2, x3, x4, x5, x6, x7, x8, x9, x10, x11, x12, x13, x14, x15);
  }

  BurstType(uint32_t x0, uint32_t x1, uint32_t x2, uint32_t x3, uint32_t x4,
            uint32_t x5, uint32_t x6, uint32_t x7) {
    set(x0, x1, x2, x3, x4, x5, x6, x7);
  }
  ...
  BurstType(uint16_t x0, uint16_t x1, uint16_t x2, uint16_t x3, uint16_t x4,
            uint16_t x5, uint16_t x6, uint16_t x7, uint16_t x8, uint16_t x9,
            uint16_t x10, uint16_t x11, uint16_t x12, uint16_t x13,
            uint16_t x14, uint16_t x15) {
    set(x0, x1, x2, x3, x4, x5, x6, x7, x8, x9, x10, x11, x12, x13, x14, x15);
  }
  ...
  void set(int64_t x) { set(x, x, x, x); }

  void set(float x0, float x1, float x2, float x3, float x4, float x5, float x6,
           float x7) {
    fp32Data_[0] = x0;
    fp32Data_[1] = x1;
    fp32Data_[2] = x2;
  ...
  void set(uint32_t x0, uint32_t x1, uint32_t x2, uint32_t x3, uint32_t x4,
           uint32_t x5, uint32_t x6, uint32_t x7) {
    u32Data_[0] = x0;
    u32Data_[1] = x1;
    u32Data_[2] = x2;
  ...
  void set(fp16 x0, fp16 x1, fp16 x2, fp16 x3, fp16 x4, fp16 x5, fp16 x6,
           fp16 x7, fp16 x8, fp16 x9, fp16 x10, fp16 x11, fp16 x12, fp16 x13,
           fp16 x14, fp16 x15) {
    fp16Data_[0] = x0;
    fp16Data_[1] = x1;
  ...
  void set(uint16_t x0, uint16_t x1, uint16_t x2, uint16_t x3, uint16_t x4,
           uint16_t x5, uint16_t x6, uint16_t x7, uint16_t x8, uint16_t x9,
           uint16_t x10, uint16_t x11, uint16_t x12, uint16_t x13, uint16_t x14,
           uint16_t x15) {
    u16Data_[0] = x0;
    u16Data_[1] = x1;
    u16Data_[2] = x2;
...
//   }
  ...
  BurstType operator+(const BurstType &rhs) const {
    BurstType ret;
    for (int i = 0; i < 4; i++) {
      ret.int64Data_[i] = int64Data_[i] + rhs.int64Data_[i];
    }
    return ret;
  }
  BurstType operator*(const BurstType &rhs) const {
